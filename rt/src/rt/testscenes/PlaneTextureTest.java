 ...
 */
public class PlaneTextureTest extends Scene {

	public PlaneTextureTest()
	{
		// Output file name
		outputFilename = new String("PlaneTextureTest");
		...
		Texture tex = new Texture("textures/wood1.jpg");
		tex.setScale(3);
		plane.material = new BlinnTexture(tex, new Spectrum(1, 1, 1), 30);
