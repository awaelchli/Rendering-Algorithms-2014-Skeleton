 ...
 */
public class DepthOfFieldTestScene extends Scene
{

    public DepthOfFieldTestScene() {

        // Output file name
        outputFilename = new String("output/testscenes/assignment6/DepthOfField/DepthOfField");
        ...
        camera = new ApertureCamera(eye, lookAt, up, fov, aspect, width, height, aperture);
...
//        CSGInstance cube = new CSGInstance(cube_, trafo);
        ...
        Sphere glassSphere = new Sphere(new Point3f(), 1);
        glassSphere.material = new Refractive(2.1f);
        trafo.setIdentity();
